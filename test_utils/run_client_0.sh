...
./auto_test_client -broker $BROKER -connection_count 1 -cert ${WORKING_DIR}/client-0-cert.pem -key ${WORKING_DIR}/client-0-key.pem -cloud-connector "http://localhost:8081"
